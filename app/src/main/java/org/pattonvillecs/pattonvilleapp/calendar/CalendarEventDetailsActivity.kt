...
import org.pattonvillecs.pattonvilleapp.ui.calendar.details.CalendarEventDetailsActivityViewModel
    ...
    companion object {
        ...
        fun createIntent(context: Context, uid: String): Intent {
            return Intent(context, CalendarEventDetailsActivity::class.java)
                    .putExtra(CalendarEventDetailsActivity.CALENDAR_EVENT_KEY, uid)
        }
    }
}
