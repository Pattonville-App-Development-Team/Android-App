...
import org.pattonvillecs.pattonvilleapp.ui.calendar.events.CalendarEventsFragmentViewModel
...
class CalendarEventsFragment : DaggerFragment(), SearchView.OnQueryTextListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getEventsAndSearch().observe(this::getLifecycle) {
            if (it != null) {
                eventAdapter.searchText = it.first
                //eventAdapter.updateDataSet(it.second.toList())
                eventAdapter.filterItems(200L)
                //eventAdapter.filterItems(it.second.toList(), 200L)
            }
        }*/
