...
public enum DataSource {
    ...
    public final String name, shortName, address, mainNumber, attendanceNumber, faxNumber;
    public final int id;
    ...
    DataSource(String name, String shortName, int id, boolean hasCalendar, boolean hasNews, boolean isDisableable,
               ...
               String address, String mainNumber, String attendanceNumber, String faxNumber, Optional<String> peachjarLink) {
        this.name = name;
